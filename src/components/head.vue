<template>
    <div class="sticky-top zindex-1 bg-white shadow">
        <header class="navigation">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="/"><img class="img-fluid" src="images/logo.png" alt="parsa"></a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="/homepage">Homepage 2</a>
                            </div>
                        </li>
                        <li class="nav-item">
...
<script>
    import headroom from "./../../public/js/headroom/headroom.js"
